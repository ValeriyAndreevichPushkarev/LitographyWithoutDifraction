...
You can make image smaller without extra expensive precision lenses.
Just use lloyd mirror
<img width="621" height="430" alt="image" src="https://github.com/user-attachments/assets/d499c0fc-a6d9-47a9-a004-3632b19f86ab" />

As you can see, AB is much bigger than BC (1/tg(a))

You can make the image smaller in height, than smaller in width.
On tho mirrors you can make images up to 1000x smaller.
Four mirrors can give you 10^3. (um->nm, two mirrors on axe X, two mirrors on axe Y, and one lense mm->um(10x))
